          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex justify-center space-x-6">
              {socialLinks.map(link => (
                <a key={link.name} href={link.href} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-sky-400 transition-colors duration-300">
             ...
             <p className="mt-6 text-slate-400">
              <a href="mailto:marciofs426@gmail.com" className="hover:text-sky-400 transition-colors">marciofs426@gmail.com</a>
            </p>
            <p className="mt-2 text-slate-400">
              <a href="tel:+5577988849278" className="hover:text-sky-400 transition-colors">(77) 98884-9278</a>
            </p>
          </div>
        </div>
      </div>
